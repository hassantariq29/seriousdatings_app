     ...
     <div class="form-horizontal">
      <div class="">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" id="eventlocation" name="location" placeholder="Enter Event Location"  value = "{!! $event -> eventLocation !!}" required>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="row">
          <div class="col-sm-6">
           <input type="text" class="form-control frm_datepicker" placeholder="From" id="fromDate" name="fromDate" value = "{!! $event -> start !!}"required>
            </div>
            <div class="col-sm-6">
          <input type="text" class="form-control frm_datepicker" placeholder="To" id="toDate" name="toDate" value = "{!! $event -> endDate !!}" required>
             </div>
             </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <textarea  class="form-control summernote" name="description">{!! $event -> desc !!}</textarea>
          </div>
        </div>
     <div class="form-group">
          <label class="col-sm-2 control-label">Price <span class="symbol required"></span></label>
          <div class="col-sm-9">
            <input type="number" class="form-control" id="price" name="price" placeholder="Enter Event Charges" value = "{!! $event -> eventPrice !!}" required>
          </div>
        </div>
        <div class="form-group">
