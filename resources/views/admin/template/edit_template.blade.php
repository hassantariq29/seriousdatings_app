	  ...
	  !!}
       <div class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control"  placeholder="Template Name" name="templatename" value = {!! $template->template_name !!} required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label">Subject <span class="symbol required"></span></label>
          <div class="col-sm-9">
            <input type="text" class="form-control"  placeholder="Enter Subject" name="templatesubject" value = {!! $template->template_subject !!}required>
          </div>
        </div>
