...
<div class="middle inner-middle">
    <div class="inner-header upcoming-banner">
        <div class="container">
            <h1><i class="calendar-event-icon"><img src="images/upcoming-event-icon.png"  alt=""></i>My Music</h1>
        </div>
    </div>
                ...
                <div class="col-md-6" style="padding:0px">
                    ...
                    <div class="middle-content-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div><h3 style="margin: 5%; color: #e21d24;font-style: italic;">My Music</h3></div>

                                <div class="page-header">
                                    <a href="{!! url() !!}/profile/music/create" class="pull-right btn btn-facebook btn-sm" type="button"><i class="fa fa-plus-square"></i>&nbsp; Add Music</a></h3>
                                </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row pic_gallery">
                                        @foreach($data['music'] as $music)
                                            <div class="col-md-8"><h3>{!! $music->title !!}</h3></div><div class="clear"></div>

                                            <div class="col-md-3">
                                            <audio controls>
                                                <source src="{!! url() !!}/images/users/{!! $data['current_user']->username !!}/music/{!! $music->music !!}" type="audio/mpeg">
