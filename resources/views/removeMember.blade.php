  ...
  @endif
    ...
    <h3>Remove Members</h3><br />
      ...
      @if($group -> id != null)
           ...
           {!! Form::open(
              array(
              'url' => 'groups/'.$group -> id.'/removeMember',
          ...
          !!}
                ...
                @if(count($group -> membersToRemove) > 0 )
                  <input type="submit" value="Remove Member(s)" class="common-red-btn button" />
                @else
