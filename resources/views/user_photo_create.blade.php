...
<div class="middle inner-middle">
    <div class="inner-header upcoming-banner">
        <div class="container">
            <h1><i class="calendar-event-icon"><img src="images/upcoming-event-icon.png"  alt=""></i>Add Pictures</h1>
        </div>
    </div>
                                ...
                                <div>
                                    ...
                                    !!}
                                            <div class="form-group frmdiv">
                                                <label for="exampleInputName2">Select Picture(s)</label><br />
