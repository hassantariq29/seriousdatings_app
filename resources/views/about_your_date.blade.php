@extends('master')
  ...
  @section('form_area')
    ...
    <div class="about-date-top-form">
            ...
            <div class="to-age">
                 <label>to:</label>
                 <input type="text" name="ageTo" placeholder="Age From"/> 
            </div>
            
               <div class="to-age">
                <label> From zipcode: <div><input type="text" name="zipcode" value ="{!! $zipcode !!}" placeholder="{!! $zipcode !!}"  id="zipCode" /></div>   Within:</label>
...
Also unassuming, the Pisces zodiac signs and meanings deal with acquiring vast amounts of knowledge,
    ...
    <div class="row">
         <div class="form-row single-line-label">
            ...
            <input type ="hidden" value="{!! $id !!}" name="lati" id="lati"/>
            <input type ="hidden" value="{!! $id !!}" name="longi" id="longi"/>
